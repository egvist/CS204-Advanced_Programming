...
#include <fstream>
#include <sstream>
#include "barisaydogan_Aydogan_BarisBaran_HW6_board.h" //change this with your board header file name
#include "barisaydogan_Aydogan_BarisBaran_HW6_player.h" //change this with your player header file name
